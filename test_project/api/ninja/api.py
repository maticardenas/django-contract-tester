...
def create_user(request, user: UserIn):
    return {"id": 1, "name": "John Doe", "email": "john.doe@example.com", "age": 30, "is_active": True}
...
def get_users(request):
    return [
        {"id": 1, "name": "John Doe", "email": "john.doe@example.com", "age": 30, "is_active": True},
        {"id": 1, "name": "Jay May", "email": "jay.may@example.com", "age": 23, "is_active": True},
    ]
